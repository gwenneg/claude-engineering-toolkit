...
### Phase 4: User exclusion

Print a numbered list of all non-noise events:
```
...
### Phase 5: Discover documentation structure
...
### Phase 7: Propose eval cases (optional)
